...
x = Dense(train_size, activation='softmax', name='predictions')(x)
...
model.save('modelsfffum/'+history_version+'.h5')
...
subimg= valid_dir+'/overextrusion/1634531405_109548img_jpg.rf.ffac2a502752b7f08819573571943873.jpg'
...
if savefigs=='y':
	...
	plt.savefig('modelsfffum/'+history_version+'_train_val_accuracy.jpg')
	...
	plt.savefig('modelsfffum/'+history_version+'_train_val_loss.jpg')
	print('Plots saved.')
else:
