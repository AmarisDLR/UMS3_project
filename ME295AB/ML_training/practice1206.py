...
x = Flatten()(last)
x = Dense(416, activation='relu', name='fc1')(x) #800 #relu
dropout=0.45
x = Dropout(dropout)(x) #0.3
x = Dense(416, activation='relu', name='fc2')(x) #800 #relu
dropout1=0.25
x = Dropout(dropout1)(x) #0.3
...
history_version = timestr+'_tl_vgg19_'+str(dropout)+'dropout_'+str(shapehw)+'inshape_'+str(lr)+'LR_'+str(epochs)+'epochs_'+str(batch_size)+'batch'
#model.save('UMS3_0/'+history_version+'.h5')
...
subimg= valid_dir+'/stringy/202111171414_UMS3_random37_100infill_0_jpg.rf.737393e066237d0cb403feb92fdc3bfd.jpg'
